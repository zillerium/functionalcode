defmodule Solution do
  ...
  def sum_powers(bound, power, bound, init_int, anchor) do
    list = get_sum_powers(bound, power, bound,[], init_int, anchor)
    IO.inspect list
    debug = read_int()
    anchor = anchor - 1
    sum_powers(bound, power, bound, init_int - 1, anchor - 1)
  end
